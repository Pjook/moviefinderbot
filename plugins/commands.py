...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/RR_Backup"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/RR_Backup')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://telegram.me/RR_Backup')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
